...
(function ($, window, document) {
    ...
    var Carousel = {
        ...
        wrapItems : function () {
            var base = this;
            var owlItem = "<div class=\"owl-item\"></div>";
            base.$userItems.wrapAll("<div class=\"owl-wrapper\">").wrap(owlItem);
            ...
            // Accesibility
            var count = 1;
            if (typeof base.options.notAriaProperties == "undefined") {
                base.$elem.find(".owl-item").each(function() {
                    if (count <= base.options.numActive) {
                        $(this).attr('aria-selected',true);
                        $(this).find('a').attr('tabindex',"0").removeAttr('role');
                    } else {
                        $(this).attr('aria-selected',false);
                        $(this).find('a').attr('tabindex',"-1").attr('role','presentation');
                    }
                    count++;
                });
            }
        ...
        buildButtons : function () {
            ...
            base.buttonPrev = $("<a href='#' class='owl-prev' onclick='return false;'/>", {
                "html" : base.options.navigationText[0] || ""
            });

            base.buttonNext = $("<a href='#' class='owl-next' onclick='return false;'/>", {
            ...
            buttonsWrapper.on("click", "a[class^=\"owl\"]", function (event) {
                event.preventDefault();
        ...
        buildPagination : function () {
            ...
            base.supraWrapper = $("<nav class=\"owl-pagination\" role=\"navigation\" aria-label=\"Slides index\" />");
            base.paginationWrapper = $("<ul></ul>");
            base.supraWrapper.append(base.paginationWrapper);
            base.owlControls.append(base.supraWrapper);
            ...
            // Replicate behaviour of mouse down for "enter" hit with keyboard
            base.paginationWrapper.on("keydown.owlControls", ".owl-page > a", function (e) {
                if (e.which == 13) {
                    if (Number($(this).parent().data("owl-page")) !== base.currentItem) {
                        base.goTo(Number($(this).parent().data("owl-page")), true);
                    }
                }
            });
        },
        ...
        updatePagination : function () {
            ...
            for (i = 0; i < base.itemsAmount; i += 1) {
                if (i % base.options.items === 0) {
                    ...
                    paginationButton.attr('data-page',counter);
                    var pageLinkSupra = $("<a href='#' class=\"owl-numbers gbl\" tabindex=\"0\" onclick=\"return false;\"></a>");
                    var counterSpan = "<span class=\"srt\">Slide "+counter+"</span>";
                    var pageLinkWithScreenReader = $(counterSpan);
                    pageLinkSupra.append(pageLinkWithScreenReader);
                    paginationButton.append(pageLinkSupra);
        ...
        checkPagination : function () {
            ...
            base.paginationWrapper.find(".owl-page").each(function () {
                if ($(this).data("owl-roundPages") === $(base.$owlItems[base.currentItem]).data("owl-roundPages")) {
                    ...
                    $(this).find(".srt").text("Slide "+$(this).attr('data-page')+" active");
                } else {
                    $(this).find(".srt").text("Slide "+$(this).attr('data-page'));
                }
            });
        },
        ...
        goTo : function (position, speed, drag) {
            ...
            var page = position+1;
            var currentPageItem = base.$elem.find(".owl-item[data-page='"+page+"']");
            var allItems = base.$elem.find(".owl-item");
        ...
        stopOnHover : function () {
            ...
            if (base.options.stopOnHover === true && base.browser.isTouch !== true && base.options.autoPlay !== false) {
                ...
                base.$elem.find('a').on("focusin", function () {
                    base.stop();
                });
                ...
                base.$elem.find('a').on("focusout", function () {
                    if (base.hoverStatus !== "stop") {
                        base.play();
                    }
                });
...
// FUNCTIONS
/** GENERAL **/
// We're using this file for functions that don't enter in a more specific group
...
// Used for handling media query related JS functions
